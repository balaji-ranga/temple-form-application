...
export class CustomerService {
  ...
  protected convertDateFromClient(customer: ICustomer): ICustomer {
    const copy: ICustomer = Object.assign({}, customer, {
      ...
      activatedDate: customer.activatedDate != null && customer.activatedDate.isValid() ? customer.activatedDate.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.activatedDate = res.body.activatedDate != null ? moment(res.body.activatedDate) : null;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((customer: ICustomer) => {
        ...
        customer.activatedDate = customer.activatedDate != null ? moment(customer.activatedDate) : null;
      });
    }
    return res;
  }
